					...
					.ajax({
						...
						success : function(data) {
							var r = $('<button data-event-id="'
									...
									+ '" onclick="unLikeEvent(this);" class="btn btn-sm btn-default like-btn"><span class="glyphicon glyphicon-heart"></span> UnLike (<span class="counts">'
									+ counts + '</span>)</button>');
					...
					.ajax({
						...
						success : function(data) {
							var r = $('<button data-event-id=" '
									...
									+ '" data-event-likes ="'
									+ counts
									+ '" onclick="likeEvent(this);" class="like-btn btn btn-sm btn-default"><span class="glyphicon glyphicon-heart-empty"></span> Like (<span class="counts">'
									+ counts + '</span>)</button> ');
							$(btnlike).replaceWith(r);
									...
									<div class="media-body">
										...
										<p>
											<c:if test="${event.notFull}">
												<button class="btn btn-sm btn-default like-btn">
													<span class="glyphicon glyphicon-glass"></span> Join
												</button>
											</c:if>
											<c:choose>
												<c:when
													...
													<button onclick="likeEvent(this);"
														...
														(<span class="counts">${event.likeCounts}</span>)
													</button>
												</c:when>
												<c:otherwise>
													<button onclick="unLikeEvent(this);"
														...
														<span class="glyphicon glyphicon-heart"></span> UnLike (<span
															class="counts">${event.likeCounts}</span>)
													</button>
												</c:otherwise>
											</c:choose>
